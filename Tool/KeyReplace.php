...
//                    dd('#'.$z.'#s');
        ...
        if($this->url)
            $tmp = preg_replace("#(?!\[_s|\[_a|\[_|\[_t|\[_ta|\[_tag)".$key1."(?!ag\d+_\]|g\d+_\]|\d+_\]|s\d+_\]|_\])#us",'<a href="'.$url.'" target="_blank" title="'.$key.'">'.$key.'</a>',$tmp,$this->all?-1:1);
        else
