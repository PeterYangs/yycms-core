...
return new class extends Migration {
    ...
    public function up()
    {
        Schema::create('article_download', function (Blueprint $table) {
            ...
            $table->integer('library_id')->default(0)->unsigned()->comment('文章库文章id');
            $table->integer('apk_id')->default(0)->unsigned()->comment('文章库软件id');
            $table->integer('download_site_id')->default(0)->unsigned()->comment('下载服务器id');
