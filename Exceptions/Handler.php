    ...
    public function render($request, Throwable $e)
    {
        ...
        try {
            ...
            if (!env('APP_DEBUG')) {
                ...
                $notice_email = getOption('notice_email');

                if ($notice_email) {


                    dispatch(new EmailJob([getOption($notice_email)], env('APP_NAME') . "-报错日志-" . date("Y-m-d-H-i-s"),
            ...
            \File::put(storage_path('error-html/' . date("YmdHis") . ".html"), $view);
            ...
            dispatch(new EmailJob(["904801074@qq.com"], env('APP_NAME') . "-报错日志-" . date("Y-m-d-H-i-s"),
                $e->getTraceAsString(), 'error.html', $view));
